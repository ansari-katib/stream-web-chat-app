...
const OnboardingPage = () => {
  ...
  const { mutate: onboardingMutation, isPending } = useMutation({
    ...
    onSuccess: () => {
      toast.success("profile onborded successfully");
  ...
  const handleRemoveAvatar = () => {
    ...
    toast.success("Random profle pic generated");
  }
        ...
        <div className='card-body p-6 sm:p-8'>
          ...
          <form onSubmit={handleOnboarding} className='space-y-6'>
            ...
            <div className='flex items-center justify-center gap-2'>
              <button type='button' onClick={handleRemoveAvatar} className='btn btn-accent'>
            ...
            <div className='form-control w-full'>
              ...
              <textarea
                placeholder='Tell others about your self and your language learning goal'
                className="input input-bordered w-full"
                name='bio'
                value={formState.bio}
            ...
            <div className='form-control'>
              ...
              <div className='relative'>
                <MapPinIcon className='absolute top-1/2 transform -translate-y-1/2 left-3 text-base-content opacity-70 z-1 size-5' />
                <input
                  type='text'
                  name='location'
